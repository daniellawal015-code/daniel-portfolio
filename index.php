...
<head>
    ...
    <link rel="icon" type="image/svg+xml" href="<?php echo BASE_PATH; ?>/public/icons/favicon.svg">
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo BASE_PATH; ?>/public/icons/favicon-32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo BASE_PATH; ?>/public/icons/favicon-16.png">
    <link rel="icon" href="<?php echo BASE_PATH; ?>/public/icons/favicon.ico">
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo BASE_PATH; ?>/public/icons/apple-touch-icon.png">

    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@500;600;700&family=Inter:wght@400;500;600&family=JetBrains+Mono:wght@400;500&display=swap" rel="stylesheet">

    <script>window.__BASE_PATH__ = <?php echo json_encode(BASE_PATH); ?>;</script>
