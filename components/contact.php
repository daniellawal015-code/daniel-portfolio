        ...
        <div class="flex flex-col gap-6">
            ...
            <div class="rounded-2xl border border-depth-2 bg-depth-1 p-6">
                ...
                <div class="mt-4 flex gap-3">
                    ...
                    <a href="[LINKEDIN URL]" data-cursor="hover" aria-label="LinkedIn"
                       class="flex h-11 w-11 items-center justify-center rounded-full border border-depth-2 text-paper transition-colors hover:border-signal hover:text-signal">
                    ...
                    <a href="mailto:daniellawal015@gmail.com" data-cursor="hover" aria-label="Email"
                       class="flex h-11 w-11 items-center justify-center rounded-full border border-depth-2 text-paper transition-colors hover:border-signal hover:text-signal">
                        <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="1.6" aria-hidden="true"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m3 6 9 7 9-7"/></svg>
                    </a>
                </div>
            </div>
